...
const ReporterProxy = requireFromPackage('fuzzy-finder', 'reporter-proxy');
...
class View extends FuzzyFinderView {
  toggle(items) {
    if (this.panel != null ? this.panel.isVisible() : undefined) {
      ...
      this.setItems(this.projectRelativePathsForFilePaths(items));
      return this.show();
    }
  }
...
module.exports = {
  ...
  getView() {
    return this.view != null ? this.view : (this.view = new View(metricsReporter));
  }
};
